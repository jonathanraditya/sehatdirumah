...
// define the path and name of cached file
	$cachefile = 'caching/atributhakcipta'.date('M-d-Y').'.php';
    ...
    <div class="container container95">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-6 col-xl-5 mt100">
                <img src="img/asset/endnotes/copyrightattribute.svg" alt="Atribut hak cipta di situs sehatdirumah.com">
                <h1 class="mf72-f48 font-weight-bold mb30 mt30">
                    <span class="cl-aqua-forest">Atribut </span>
                    <span class="cl-tangerine">Hak Cipta</span>
                </h1>
                <p>Kami mengucapkan terima kasih yang sebesar-besarnya atas sumber-sumber dari berbagai aset yang dapat diakses bebas dari internet.</p>
                <p>Internet telah mengubah cara manusia berkomunikasi dan menyelesaikan banyak hal.</p>
                <p>Seperti pendiri internet, kami juga memiliki keyakinan yang sama, bahwa kebebasan dan keterbukaan dapat mengubah dunia.</p>
                <footer>
                ...
                <div class="row justify-content-left mt40">
                    ...
                    <div class="row">
                        ...
                        <a href="bantuan?h=atributhakcipta" class="f16 about-item-active a-none">Atribut Hak Cipta</a>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-5 mt100">
                <h2 class="font-weight-bold mf48-f32">
                    <span class="cl-aqua-forest">Terima Kasih </span>
                    <span class="cl-tangerine">Kepada</span>
                </h2>

                <?php copyrightattribute() ?>
