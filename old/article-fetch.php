...
while($row_art=$result_artdb->fetch_assoc()){
    ...
    echo "<div>";
    echo "<div class='font-istok font-weight-bold font10-15 cl-dusty-gray'>".$dt_last_update." - ".$writer."</div>";
    echo "<h5 class='font-weight-bold'>".$title."</h5>";
    echo "<p class='marginb5'>".$headline."</p>";
    echo "<div class='cl-curious-blue font-lato font12-18'><a href='tag.php?search=".$tag1."'>#<span>$tag1</span></a>  <a href='tag.php?search=".$tag2."'>#<span>$tag2</span></a>  <a href='tag.php?search=".$tag3."'>#<span>$tag3</span></a> <a href='tag.php?search=".$tag4."'>#<span>$tag4</span></a></div>";
    echo "<hr>";
    echo "</div>";
    echo "</div></a>";
    }
