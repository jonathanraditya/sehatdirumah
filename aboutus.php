...
// define the path and name of cached file
	$cachefile = 'caching/tentangkami'.date('M-d-Y').'.php';
    ...
    <div class="container container95">
        ...
        <div class="row justify-content-center justify-content-lg-start justify-content-xl-start">
            <div class="col-12 col-md-6 col-lg-6 col-xl-5 mt100">
                <img src="img/asset/endnotes/aboutus.svg" alt="tentang tim sehatdirumah.com">
                <h1 class="mf72-f48 font-weight-bold mb30 mt30">
                    <span class="cl-aqua-forest">Tentang </span>
                    <span class="cl-tangerine">Kami</span>
                </h1>
                <p>Halo, terima kasih sudah tertarik dengan apa yang kami hadirkan ini. Semua dunia, tak terkecuali Indonesia sedang berada di kondisi yang sulit.</p>
                <p>Misi kami adalah memberikan pandangan yang berbeda tentang kondisi ini kepada Indonesia dan Dunia. Berita-berita negatif selalu datang silih berganti, banyak sekali informasi yang melewati setiap harinya.</p>
                <p>Melalui teknologi, kami akan membantu masyarakat mengetahui bahwa data yang ada tidak seseram kelihatannya, dan kita semua sudah berada di jalan yang tepat untuk mengendalikan semuanya.</p>
                <p>Akan selalu ada update dan analisis terbaru setiap harinya mengenai kondisi terkini melalui laman ini di sehatdirumah.com.</p>
                <p>Semoga kita semua selalu dalam kondisi yang sehat walafiat.</p>
                ...
                <div class="row justify-content-left mt40">
                    ...
                    <div class="row">
                        ...
                        <a href="bantuan?h=tentangkami" class="f16 about-item-active a-none">Tentang Kami</a>
