...
<html lang="id">
    <head>
        ...
        <!--end of bootstrap , user-scalable=no-->
        <link rel="stylesheet" href="style-landing.min.css">
        <link rel="stylesheet" href="style-nav.min.css?ver=186201952">
        <link rel="dns-prefetch" href="https://www.google-analytics.com">
        <link rel="preconnect" href="https://www.google-analytics.com" crossorigin>
        <meta name="description" content="<?php echo $desc ?>">
        <meta name="viewport" content="width=760px, user-scalable=no, shrink-to-fit=no">
    ...
    <body class="content">
            ...
            <div class="row justify-content-center pb25">
                <div class="col-xl-8 col-lg-10 col-md-12">
                    <svg version="1.2" baseProfile="tiny"
                        ...
                        <g id="id-ma" class="click-point" onclick="window.location='region?r=maluku'" onmouseover="popUp('id-ma')">
                        ...
                        <g id="id-mu" class="click-point" onclick="window.location='region?r=malukuutara'" onmouseover="popUp('id-mu')">
                        ...
                        <g id="id-sb" class="click-point" onclick="window.location='region?r=sumaterabarat'" onmouseover="popUp('id-sb')">
                        ...
                        <g id="id-sr" class="click-point" onclick="window.location='region?r=sulawesibarat'" onmouseover="popUp('id-sr')">
            ...
            <div class="d-flex justify-content-center">
                <div class="p-2">
                    ...
                    <table class="table table-hover ltable-font">
                        <thead>
                        <tr>
                            <th class="ld-ntb ld-nlb">Tren Pertambahan Kasus 90 hari Terakhir<a class="a-none a-inh-sup click-point" data-id="85"><sup>[85]</sup></a></th>
                        ...
                        <tbody id="toggleDataLanding">
                            <?php fcLandingTable() ?>
                            <?php fcLandingTableDetail() ?>
                        </tbody>
                        
                    </table>

                    <div class="d-none"><span style="border-radius:7px; background-color:#5BAEE5; padding:5px 10px; color:white; font-weight:bold; font-size:16px;" class="click-point" id='toggleButton' onclick='toggleMoreData()'>Tampilkan Semua Provinsi</span></div>
        ...
        <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-center flex-wrap">
                        <div class="p-2">
                            <div class="d-flex flex-nowrap">
                                ...
                                <div class="p-2 mt20 cl-dusty-gray">&asymp;20 orang<a class="a-none a-inh-sup click-point" data-id="64"><sup>[64]</sup></a></div>
                            </div>
                        </div>
                        <div class="p-2">
                            <div class="d-flex flex-nowrap">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-12 f24 cl-dusty-gray font-weight-bold">
                    <?php fcLandingKasusSatuJuta1() ?>
                    <?php fcLandingKasusSatuJuta2() ?>
        ...
        <!--<script>
            function toggleMoreData(){
                var targetData=document.getElementById('toggleDataLanding');
                var toggleButton=document.getElementById('toggleButton');
                if(toggleButton.innerHTML==='Tampilkan Semua Provinsi'){
                    targetData.innerHTML="";
                    toggleButton.innerHTML="Sembunyikan Provinsi Lainnya'";
                }else{
                    targetData.innerHTML="";
                    toggleButton.innerHTML='Tampilkan Semua Provinsi';
                }
