...
function cacheLandingTable(){
    ...
    $region=array(
        ...
        'malukupapua' => 'mu|ma|pb|pa',
        'balinusatenggara' => 'ba|nt|nb');
    $inputColumnRG=array('landingtable2','landingtable3','landingtable4','landingtable5','landingtable6','landingtable7');
    $combinedResult='';
    $updateResult='';
    foreach($global as $code){
        ...
        $fetchResult=$fetchResult."<td class='ld-trend-cell ld-nlb text-center'><svg xmlns='http://www.w3.org/2000/svg' height='45' width='170' viewBox='0 0 170 45' style='background-color:#EDF5EE'><g transform='translate(0 0)' stroke-width='2.5px'>".$dc_inctrend."</g></svg></td>";
        $fetchResult=$fetchResult."<td>".$namaDaerah."</td>";
        $fetchResult=$fetchResult."<td>".$t."</td>";
        $fetchResult=$fetchResult."<td>".$t_inc."</td>";
        $fetchResult=$fetchResult."<td>".$tr."</td>";
        $fetchResult=$fetchResult."<td>".$tr_inc."</td>";
        $fetchResult=$fetchResult."<td>".$td."</td>";
        $fetchResult=$fetchResult."<td class='ld-nrb'>".$td_inc."</td>";
