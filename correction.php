...
// define the path and name of cached file
	$cachefile = 'caching/berikoreksi'.date('M-d-Y').'.php';
    ...
    <div class="container container95">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-6 col-xl-5 mt100">
                <img src="img/asset/endnotes/correction.svg" alt="beri koreksi kepada tim sehatdirumah.com">
                <h1 class="mf72-f48 font-weight-bold mb30 mt30">
                    <span class="cl-aqua-forest">Beri </span>
                    <span class="cl-tangerine">Koreksi</span>
                </h1>
                <p>Selalu berusaha memberikan yang terbaik adalah prinsip kami. Namun tidak kami pungkiri, bahwa selalu ada celah kami berbuat kesalahan yang berada di luar perhatian kami.</p>
                <p>Oleh sebab itu, mari bergabung bersama kami untuk membuat konten yang disajikan lebih baik.</p>
                <p>Percayalah, 6 miliar orang di dunia memiliki kemampuan yang lebih besar daripada sekadar tim sehatdirumah.com.</p>
                <p>Cukup ceritakan apa yang telah kamu temukan pada kolom berikut, dan tim kami akan membantu menindaklanjutinya.</p>
                <P>Komunikasikan apa yang anda temukan kepada tim kami di <a href="mailto:halo@sehatdirumah.com">halo@sehatdirumah.com</a>.</P>
                <footer>
                ...
                <div class="row justify-content-left mt40">
                    ...
                    <div class="row">
                        ...
                        <a href="bantuan?h=berikoreksi" class="f16 about-item-active a-none">Beri Koreksi</a>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-5 mt100 d-none">
                <h2 class="font-weight-bold mf48-f32">
                    <span class="cl-aqua-forest">Daftar </span>
                    <span class="cl-tangerine">Koreksi</span>
                </h2>
                <div class="f16 cl-black">
                    Masukan yang <b>belum</b> ditindaklanjuti akan kami tandai dengan
                    <span class="cl-tangerine font-italic"><b>warna jingga</b></span>, dan yang <b>telah</b> kami tindaklanjuti dengan
                    <span class="cl-aqua-forest font-italic"><b>warna hijau</b></span>. Untuk masukan menurut kami <b>tidak relevan</b> akan kami tandai dengan
                    <span class="cl-chestnut font-italic"><b>warna merah</b></span>, dan akan secara otomatis terhapus oleh sistem setelah 3 hari.
                </div>
                <div class="f24 font-weight-bold mt20">Berikan masukan</div>
                <!--input-->
                <form class="mt10">
                    <div class="mr40">
                        <div class="form-group marginb1">
                            <input type="text" class="form-control font-weight-bold f12 cl-dusty-gray c-f-input" value="Tanpa_nama0028">
                        </div>
                        <div class="form-group marginb3">
                            <input type="text" class="form-control f14 cl-dusty-gray c-f-input" placeholder="katakan sesuatu...">
                        </div>
                    </div>
                    <div class="text-right">
                        <span class="cl-sum1">0/120</span>
                        <button type="submit" class="btn btn-send">
                            <img src="img/asset/endnotes/send.svg" alt="send button">
                        </button>
                    </div>
                </form>

                <div class="f24 font-weight-bold">Masukan</div>

                <!--input fetch-->
                <div class="cor-done mt25">
                    <div class="f16 font-weight-bold cl-dusty-gray">Rafael Federico</div>
                    <div class="f16">Semoga kita semua dalam keadaan sehat ya, jangan lupa #JagaKebersihan dan #diRumahAja!</div>
                    <div class="font-italic f16 mt10"><span class="font-weight-bold cl-dusty-gray">Jonathan : </span><span class="cl-black">Terima kasih atas masukannya!</span></div>
                </div>
                <div class="cor-pending mt25">
                    <div class="f16 font-weight-bold cl-dusty-gray">Rafael Federico</div>
                    <div class="f16">Semoga kita semua dalam keadaan sehat ya, jangan lupa #JagaKebersihan dan #diRumahAja!</div>
                    <div class="font-italic f16 mt10"><span class="font-weight-bold cl-dusty-gray">Jonathan : </span><span class="cl-black">Terima kasih atas masukannya!</span></div>
                </div>
                <div class="cor-reject mt25">
                    <div class="f16 font-weight-bold cl-dusty-gray">Rafael Federico</div>
                    <div class="f16">Semoga kita semua dalam keadaan sehat ya, jangan lupa #JagaKebersihan dan #diRumahAja!</div>
                    <div class="font-italic f16 mt10"><span class="font-weight-bold cl-dusty-gray">Jonathan : </span><span class="cl-black">Terima kasih atas masukannya!</span></div>
                </div>
