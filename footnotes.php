...
// define the path and name of cached file
	$cachefile = 'caching/catatankaki'.date('M-d-Y').'.php';
    ...
    <div class="container container95">
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-6 col-xl-5 mt100">
                <img src="img/asset/endnotes/footnotes.svg" alt="catatan kaki perhitungan data situs sehatdirumah.com">
                
                <h1 class="mf72-f48 font-weight-bold mb30 mt30">
                    <span class="cl-aqua-forest">Catatan </span>
                    <span class="cl-tangerine">Kaki</span>
                </h1>
                
                <p>Setiap analisis yang kami lakukan memiliki dasar perhitungan, serta input data dari sumber terpercaya. </p>
                <p>Cari tahu lebih lanjut mengenai penjelasan setiap bagian perhitungan yang meragukan pada bagian berikut.</p>
                <p>Jangan ragu untuk memberikan masukan kepada kami apabila anda menemukan hal yang meragukan dan butuh informasi tambahan terkait hal itu.</p>
                <p>Hubungi kami melalui email <a href="mailto:halo@sehatdirumah.com" class="a-none"><span class="cl-black font-underline font-italic">halo@sehatdirumah.com</span></a>.</p>
                <p>Tetap di rumah, jaga kesehatan dan kebersihan.</p>
                <footer>
                ...
                <div class="row justify-content-left mt40">
                    ...
                    <div class="row">
                        <a href="bantuan?h=catatankaki" class="f16 about-item-active a-none">Catatan Kaki</a>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-5 mt100">
                <h2 class="font-weight-bold mf48-f32">
                    ...
                    <span class="cl-tangerine">Catatan Kaki</span>
                </h2>
                <!--Footnotes list-->
                <?php $fetch=footnotes() ?>
